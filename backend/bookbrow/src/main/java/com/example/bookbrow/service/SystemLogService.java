...
import com.example.bookbrow.repository.SystemLogRepository;
...
public class SystemLogService {
    ...
    public List<Map<String, Object>> getRecentLogs(int limit) {
        ...
        return logs.stream().map(log -> {
            ...
            logMap.put("performedBy", log.getPerformedByName() != null ? log.getPerformedByName() : log.getPerformedBy());
            logMap.put("createdAt", log.getCreatedAt().toString());
            logMap.put("timeAgo", getTimeAgo(log.getCreatedAt()));
            return logMap;
    ...
    public Page<Map<String, Object>> getLogs(int page, int limit) {
        ...
        return logPage.map(log -> Map.of(
            "id", log.getId(),
            "actionType", log.getActionType(),
            "entityType", log.getEntityType(),
            "entityId", log.getEntityId(),
            "description", log.getDescription(),
            "performedBy", log.getPerformedByName() != null ? log.getPerformedByName() : log.getPerformedBy(),
