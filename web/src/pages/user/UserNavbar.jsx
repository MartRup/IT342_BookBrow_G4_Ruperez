    ...
    <>
      <nav className="usr-navbar">
        ...
        <div className="usr-nav-right">
          <div className="usr-user-info" onClick={() => navigate('/settings')} style={{ cursor: 'pointer' }} title="Settings">
          ...
          <button className="usr-logout-btn" onClick={() => setShowLogoutConfirm(true)}>
            Logout
      ...
      {showLogoutConfirm && (
        <div className="usr-logout-overlay" onClick={() => setShowLogoutConfirm(false)}>
          <div className="usr-logout-modal" onClick={(e) => e.stopPropagation()}>
            <div className="usr-logout-icon">
            ...
            <div className="usr-logout-actions">
              <button
                className="usr-logout-cancel-btn"
                onClick={() => setShowLogoutConfirm(false)}
              >
                Cancel
              </button>
              <button
                className="usr-logout-confirm-btn"
