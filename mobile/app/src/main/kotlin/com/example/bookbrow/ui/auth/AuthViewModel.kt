...
import com.example.bookbrow.data.remote.model.AuthResponse
import com.example.bookbrow.data.repository.AuthRepository
import kotlinx.coroutines.launch

/**
 * AuthViewModel – shared ViewModel for both LoginActivity and RegisterActivity.
 *
 * Exposes:
 *   loginState  – LiveData<UiState<AuthResponse>> for login results
 *   registerState – LiveData<UiState<AuthResponse>> for register results
 *
